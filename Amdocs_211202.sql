...
L.pMax,L.actDrx, L.t300,L.t301, L.t310,L.t311,L.tEvaluation,L.tHystNormal,L.qHyst,L.cellReSelPrio,L.n310,L.qrxlevmin,L.QrxlevminintraF,L.sIntrasearch,
...
L.threshold2WcdmaQci1, L.threshold4, L.a3Offset, L.measQuantityUtra, L.threshold2InterFreq, L.dlCellPwrRed, L.expectedCellSize, L.prachConfIndex,
L.prachCS, L.dlChBw1, L.dlChBw2, 
...
CREATE TABLE WCEL_PARAM1 AS SELECT
W.WCELName, W.WBTSName, W.Cluster, W.Region, W.Depto, W.Mun, W.Prefijo, W.Banda, W.PLMN_id, W.Sector, W.WCEL_id, W.RNCName, W.RNC_id, W.WBTS_id, W.CId, W.Latitud, W.Longitud, W.Antena, W.Altura_Antena, W.Azimuth, W.Tilt_E, W.Tilt_M, W.Map_Length, W.Map_Beam, W.PriScrCode, (W.angle)/10 AS tilt, W.LAC, W.RAC, W.AdminCellState, W.WCelState, W.moversion AS version , W.URAid, W.PCH24kbpsEnabled, W.NbrOfSCCPCHs,
W.Tcell, W.PrxTarget, 100*((power(10,W.PtxPrimaryCPICH/100.0)/1000)/(power(10,W.PtxCellMax/100.0)/1000)) AS CpichPwrRatio, W.PtxPrimaryCPICH,
W.PtxCellMax, W.MaxDLPowerCapability, W.PtxHighHSDPAPwr, W.PtxTarget, W.PtxTargetPSMax, W.PtxTargetPSMin, W.PtxMaxHSDPA,
...
L.mbmsNeighCellConfigInterF, L.minDeltaRsrpIMLB, L.minDeltaRsrqIMLB, L.qOffFrq, L.reducedMeasPerformance , I.dlCarFrqEut AS dlCarFrqEutMiss
