...
B.Latitud, B.Longitud, B.Zona, BL.Azimuth AS Az, BL."Tilt Electrico" AS Tilt_E,
...
SELECT
L.LNCELname, L.LNBTSname, L.Zona, L.Cluster, L.Region, L.Depto, L.Mun, substr(L.LNBTSname,1,3) AS Prefijo, L.Sector, L.KeySector, L.PLMN_id, L.MRBTS_id,
L.LNBTS_id, L.LNCEL_id, L.Banda, L.earfcnDL, L.eutraCelId, L.phyCellId, L.rootSeqIndex, L.PowerBoost, L.pMax, L.dlCellPwrRed, L.expectedCellSize,
L.prachConfIndex, L.prachCS,
...
L.PCIMod3, L.PCIMod6, L.PCIMod30, L.earfcnUL, L.moVersion, L.moVersionl, L.lcrId, (L.MRBTS_id||L.lcrId) AS Klcrid, L.tac,L.cellType,L.maxNumActDrb,
L.maxNumActUE,L.maxNumUeDl,L.maxNumUeUl,L.mbrSelector,L.t302,L.t304InterRAT,L.t304InterRATGsm,L.t304IntraLte,L.t304eNaccGsm,L.t320,L.hopModePusch,
L.actDrx, L.t300,L.t301,L.t310,L.t311,L.tEvaluation,L.tHystNormal,L.qHyst,L.cellReSelPrio,L.n310,L.qrxlevmin,L.QrxlevminintraF,L.sIntrasearch,
L.sNonIntrsearch, L.threshold1, L.threshold3, L.threshold3a, L.threshold2InterFreqQci1, L.threshold2a, L.threshold2aQci1, L.threshold2Wcdma,
L.threshold2WcdmaQci1, L.threshold4, L.a3Offset, L.measQuantityUtra, L.threshold2InterFreq, L.dlChBw1, L.dlChBw2, L.blankedPucch, L.numBlankDlPrbsDown,
L.numBlankDlPrbsUp, L.actDlSlimCarrier, L.actDl256QamChQualEst, L.dlsDciCch
L.a2TimeToTriggerActWcdmaMeas, L.DistName, S.Escenario_1900,
...
SELECT DISTINCT
WCEL.name AS WCELName, B.Cluster, B.Region, B.Departamento AS Depto, B.Municipio AS Mun, substr(WCEL.name,1,3) AS Prefijo, B.Zona, B.Latitud, B.Longitud, BL.Antena, BL."Altura Antena" AS Altura_Antena, BL.Azimuth, BL."Tilt Electrico" AS Tilt_E, BL."Tilt Mecanico" AS Tilt_M, BL."Map Length" AS Map_Length, BL."Map Beam" AS Map_Beam, S.Escenario_1900, WCEL.UARFCN, CASE WHEN WCEL.UARFCN < 9685 THEN 850 ELSE 1900 END Banda, WBTS.name AS WBTSName, WCEL.PLMN_id, RNC.name AS RNCName, RNC.RNC_id, WBTS.WBTS_id, WCEL.WCEL_id, WCEL_URAID.Value AS URAid,
...
W.Tcell, W.PrxTarget, 100*((power(10,W.PtxPrimaryCPICH/100.0)/1000)/(power(10,W.PtxCellMax/100.0)/1000)) AS CpichPwrRatio, W.PtxPrimaryCPICH, W.PtxCellMax,
W.MaxDLPowerCapability, W.PtxHighHSDPAPwr, W.PtxTarget, W.PtxTargetPSMax, W.PtxTargetPSMin, W.PtxMaxHSDPA,
...
SELECT
L.Cluster, L.Region, L.Zona, L.Depto, L.Mun, L.Prefijo, L1.Cluster AS ClusterT, L1.Region AS RegionT, L1.Zona AS ZonaT, L1.Depto AS DeptoT,
L1.Mun AS MunT, L1.Prefijo AS PrefijoT, (L.LNCELname || L.rootSeqIndex) AS Key, L.LNCELname AS LNCELSRC, L1.LNCELname AS LNCELTGT, L.rootSeqIndex,
CASE WHEN (L.LNBTSName = L1.LNBTSName) THEN 1 ELSE 0 END AS SameSite, CASE WHEN (L.earfcnDL = L1.earfcnDL) THEN 1 ELSE 0 END AS SameCarrier,
L.MRBTS_Id, L.LNBTS_Id, L.LNCEL_Id, (L.LNBTSName || substr(L.LNCELname,-1,1)) AS KeySecS, L1.MRBTS_Id AS MRBTSIdT, L1.LNBTS_Id AS LNBTSIdT,
L1.LNCEL_Id AS LNCEL_IdT, (L1.LNBTSName || substr(L1.LNCELname,-1,1)) AS KeySecT, L.earfcnDL AS EARFCN_SRC, L1.earfcnDL AS EARFCN_TGT,
L.LNBTSName AS LNBTSSrc, L1.LNBTSName AS LNBTSTgt, L.LNBTS_OpSt AS LNBTS_OpStS, L.LNCEL_AdSt AS LNCEL_AdStS ,L.LNCEL_OpSt AS LNCEL_OpStS,
L1.LNBTS_OpSt AS LNBTS_OpStT, L1.LNCEL_AdSt AS LNCEL_AdStT, L1.LNCEL_OpSt AS LNCEL_OpStT,
ROUND (12756273.2 * ASIN(MIN (1 , SQRT(POWER( SIN(RADIANS(L.Latitud - L1.Latitud)/2) , 2) +
COS(RADIANS(L.Latitud)) * COS(RADIANS(L1.Latitud)) * POWER ( SIN(RADIANS(L.Longitud - L1.Longitud)/2) , 2)))) , 0) AS Distance,
L.Latitud, L.Longitud, L1.Latitud AS LatitudT, L1.Longitud AS LongitudT, L.Az, L1.Az AS AzT
...
SELECT DISTINCT
l.PLMN_Id, l.LNCELS, l.LNCELT, l.IntraPrepSR, l.IntraSR, l.IntraATT, l.IntraCancelR, l.InterPrepSR, l.InterSR, l.InterATT, l.InterFR, l.LBSR ,l.LBATT,
l.LateHO, l.EarlyHOtype1, l.EarlyHOtype2, l.Distance, r.MRBTS_id, r.LNBTS_id, r.LNCEL_id, r.LNREL_id, r.amleAllowed, r.handoverAllowed, r.removeAllowed,
r.cellIndOffNeigh, r.cellIndOffNeighDelta, r.nrControl,r.nrStatus, r.SameSite, r.SameSector, r.Banda, r.BandaT, r.bearing,r.bearback,r.ThetaAng,
r.CoefCoOrient,r.Az,r.AzT, r.Cluster, r.Region, r.Depto, r.Mun, r.ClusterT, r.RegionT, r.DeptoT, r.MunT, r.LNCELname, r.LNCELnameT, r.lcrId,
r.lcrIdT, r.PLMN_id, r.PLMN_idT, r.Prefijo, l.Cluster,l.ClusterT,l.MRBTS_id,l.LNBTS_id,l.LNCEL_id,l."Source MRBTS name",l."Source LNBTS name",
l.MRBTS_IdT, l.LNBTS_IdT, l.LNCEL_IdT, l.LcrIdT, l.LNBTST, l.MCC, l.MNC, l.ECI, r.moVersion,r.mcc,r.mnc, r.SBTS_id,r.name,r.LNBTSname,r.LNBTSnameT,
r.MRBTS_idT,r.LNBTS_idT,r.LNCEL_idT,r.eutraCelId,r.PowerBoost,r.PCI,r.RSI,r.tac,r.eutraCelIdT, r.PowerBoostT,r.PCIT,r.RSIT,r.tacT,r.Estado,r.EstadoT
...
--
--
DROP TABLE IF EXISTS PSGRP1;
CREATE TABLE PSGRP1 AS
SELECT DISTINCT
L.LNBTSname, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.actLBPowerSaving,
P.moVersion, P.distName, P.PLMN_id, P.MRBTS_id, P.LNBTS_id, P.PSGRP_id,  P.lbpsCSONCtlEnabled, P.lbpsLastCellMinLoad,
P.lbpsLastCellSOEnabled, P.lbpsMaxLoad, P.lbpsMinLoad, P.lbpsPdcchLoadOffset, P.lbpsLastCellRTXMinLoad,
P.lbpsRTXCellCapOffset, P.lbpsRTXMaxLoad, P.lbpsRTXMinLoad,
P1.moVersion AS moVersion1, P1.distName AS distName1, P1.OPTITEM_id, P1.lbpsDayOfWeek, P1.lbpsDuration,
P1.lbpsStartTimeHour, P1.lbpsStartTimeMinute, P1.lbpsSuspended
FROM (PSGRP P LEFT JOIN LNBTS_Full L ON P.PLMN_id = L.PLMN_id AND P.MRBTS_id = L.MRBTS_id AND P.LNBTS_id = L.LNBTS_id)
LEFT JOIN PSGRP_LBPSPERIODLIST P1 ON P.PLMN_id = P1.PLMN_id AND P.MRBTS_id = P1.MRBTS_id AND P.LNBTS_id = P1.LNBTS_id
AND P.PSGRP_id = P1.PSGRP_id;
--
DROP TABLE IF EXISTS PSGRP2;
CREATE TABLE PSGRP2 AS
SELECT DISTINCT
L.LNBTSname, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.actLBPowerSaving,
P.moVersion, P.distName, P.PLMN_id, P.MRBTS_id, P.LNBTS_id, P.PSGRP_id, P.lbpsCSONCtlEnabled, P.lbpsLastCellMinLoad,
P.lbpsLastCellSOEnabled, P.lbpsMaxLoad, P.lbpsMinLoad, P.lbpsPdcchLoadOffset, P.lbpsLastCellRTXMinLoad,
P.lbpsRTXCellCapOffset, P.lbpsRTXMaxLoad, P.lbpsRTXMinLoad,
P2.moVersion AS moVersion2, P2.distName AS distName2, P2.OPTITEM_id, P2.lbpsCellSOOrder, P2.lnCelId, L2.LNCELname
FROM ((PSGRP P LEFT JOIN LNBTS_Full L ON P.PLMN_id = L.PLMN_id AND P.MRBTS_id = L.MRBTS_id AND P.LNBTS_id = L.LNBTS_id)
LEFT JOIN PSGRP_LBPSCELLLIST P2 ON P.PLMN_id = P2.PLMN_id AND P.MRBTS_id = P2.MRBTS_id AND P.LNBTS_id = P2.LNBTS_id
AND P.PSGRP_id = P2.PSGRP_id) LEFT JOIN LNCEL_Full L2 ON P2.PLMN_id = L2.PLMN_id AND P2.MRBTS_id = L2.MRBTS_id
AND P2.LNBTS_id = L2.LNBTS_id AND P2.lnCelId = L2.lnCel_Id;
--
--
DROP TABLE IF EXISTS LnCel_9560;
CREATE TABLE LnCel_9560 AS
SELECT DISTINCT
L.Zona, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.MRBTS_id, L.LNBTS_id, L.LNCEL_id,
L.LNBTSname, L.LNCELname, L.earfcnDL, L.sector, L.Az, L.tilt, L.Tilt_E, L.Tilt_M, L.Antena, L.Altura_Antena
FROM LTE_Param AS L
WHERE L.earfcnDL = 9560 AND L.LNBTSname IS NOT NULL;
--
DROP TABLE IF EXISTS LnCel_3225;
CREATE TABLE LnCel_3225 AS
SELECT DISTINCT
L.Zona, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.MRBTS_id, L.LNBTS_id, L.LNCEL_id,
L.LNBTSname, L.LNCELname, L.earfcnDL, L.sector, L.Az, L.tilt, L.Tilt_E, L.Tilt_M, L.Antena, L.Altura_Antena
FROM LTE_Param AS L
WHERE L.earfcnDL = 3225 AND L.LNBTSname IS NOT NULL;
--
DROP TABLE IF EXISTS LnCel_3075_3100;
CREATE TABLE LnCel_3075_3100 AS
SELECT DISTINCT
L.Zona, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.MRBTS_id, L.LNBTS_id, L.LNCEL_id,
L.LNBTSname, L.LNCELname, L.earfcnDL, L.sector, L.Az, L.tilt, L.Tilt_E, L.Tilt_M, L.Antena, L.Altura_Antena
FROM LTE_Param AS L
WHERE (L.earfcnDL = 3075 OR L.earfcnDL = 3100)  AND L.LNBTSname IS NOT NULL;
--
DROP TABLE IF EXISTS LnCel_626_651;
CREATE TABLE LnCel_626_651 AS
SELECT DISTINCT
L.Zona, L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.MRBTS_id, L.LNBTS_id, L.LNCEL_id,
L.LNBTSname, L.LNCELname, L.earfcnDL, L.sector, L.Az, L.tilt, L.Tilt_E, L.Tilt_M, L.Antena, L.Altura_Antena
FROM LTE_Param AS L
WHERE (L.earfcnDL = 626 OR L.earfcnDL = 651) AND L.LNBTSname IS NOT NULL;
--
--
DROP TABLE IF EXISTS LnCel_Colocate;
CREATE TABLE LnCel_Colocate AS
SELECT DISTINCT
L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.LNBTSname, L.sector
FROM LTE_Param AS L;
--
--
DROP TABLE IF EXISTS LnCel_Colocate2;
CREATE TABLE LnCel_Colocate2 AS
SELECT DISTINCT
L.Cluster, L.Region, L.Depto, L.Mun, L.Prefijo, L.PLMN_id, L.LNBTSname, L.sector,
CASE WHEN (L1.earfcnDL = 3075 OR L1.earfcnDL = 3100) THEN 1 ELSE 0 END AS L2600_1,
CASE WHEN L2.earfcnDL = 3225 THEN 1 ELSE 0 END AS L2600_2,
CASE WHEN L3.earfcnDL = 9560 THEN 1 ELSE 0 END AS L700,
CASE WHEN (L4.earfcnDL = 651 OR L4.earfcnDL = 626) THEN 1 ELSE 0 END AS L1900,
L1.Az AS Az_2600_1, L2.Az AS Az_2600_2, L3.Az AS Az_700, L4.Az AS Az_1900
FROM (((LnCel_Colocate AS L LEFT JOIN LnCel_3075_3100 L1 ON L.PLMN_id = L1.PLMN_id AND L.LNBTSname = L1.LNBTSname
AND L.sector = L1.sector) LEFT JOIN LnCel_3225 L2 ON L.PLMN_id = L2.PLMN_id AND L.LNBTSname = L2.LNBTSname
AND L.sector = L2.sector) LEFT JOIN LnCel_9560 L3 ON L.PLMN_id = L3.PLMN_id AND L.LNBTSname = L3.LNBTSname
AND L.sector = L3.sector) LEFT JOIN LnCel_626_651 L4 ON L.PLMN_id = L4.PLMN_id AND L.LNBTSname = L4.LNBTSname
AND L.sector = L4.sector;
--
--
DROP TABLE IF EXISTS PSGRP2;
CREATE TABLE PSGRP2 AS
...
P.lbpsLastCellSOEnabled, P.lbpsMaxLoad, P.lbpsMinLoad, P.lbpsPdcchLoadOffset, P.lbpsLastCellRTXMinLoad,
P.lbpsRTXCellCapOffset, P.lbpsRTXMaxLoad, P.lbpsRTXMinLoad,
P2.moVersion AS moVersion2, P2.distName AS distName2, P2.OPTITEM_id, P2.lbpsCellSOOrder, P2.lnCelId, L2.LNCELname, L2.Sector
FROM ((PSGRP P LEFT JOIN LNBTS_Full L ON P.PLMN_id = L.PLMN_id AND P.MRBTS_id = L.MRBTS_id AND P.LNBTS_id = L.LNBTS_id)
LEFT JOIN PSGRP_LBPSCELLLIST P2 ON P.PLMN_id = P2.PLMN_id AND P.MRBTS_id = P2.MRBTS_id AND P.LNBTS_id = P2.LNBTS_id
AND P.PSGRP_id = P2.PSGRP_id) LEFT JOIN LNCEL_Full L2 ON P2.PLMN_id = L2.PLMN_id AND P2.MRBTS_id = L2.MRBTS_id
AND P2.LNBTS_id = L2.LNBTS_id AND P2.lnCelId = L2.lnCel_Id;
--
DROP TABLE IF EXISTS PSGRP3;
CREATE TABLE PSGRP3 AS
SELECT DISTINCT
P.LNBTSname, P.Cluster, P.Region, P.Depto, P.Mun, P.Prefijo, P.actLBPowerSaving,
P.moVersion, P.distName, P.PLMN_id, P.MRBTS_id, P.LNBTS_id, P.PSGRP_id, P.lbpsCSONCtlEnabled, P.lbpsLastCellMinLoad,
P.lbpsLastCellSOEnabled, P.lbpsMaxLoad, P.lbpsMinLoad, P.lbpsPdcchLoadOffset, P.lbpsLastCellRTXMinLoad,
P.lbpsRTXCellCapOffset, P.lbpsRTXMaxLoad, P.lbpsRTXMinLoad, P.moVersion2, P.distName2, P.OPTITEM_id,
P.lbpsCellSOOrder, P.lnCelId, P.LNCELname, P.Sector, L3.L2600_1, L3.L2600_2, L3.L700, L3.L1900,
(L3.L2600_1 + L3.L2600_2 + L3.L700 + L3.L1900) AS CarrierCnt, L3.Az_2600_1, L3.Az_2600_2, L3.Az_700, L3.Az_1900
FROM PSGRP2 P LEFT JOIN LnCel_Colocate2 L3 ON P.PLMN_id = L3.PLMN_id AND P.LNBTSname = L3.LNBTSname AND P.Sector = L3.sector
;
--
...
--
;
DROP TABLE IF EXISTS Sector_L1900;
CREATE TABLE Sector_L1900 AS
SELECT DISTINCT
r.LNBTSname, SUBSTR(r.LNCELname, 1, INSTR(r.LNCELname, '_')-1) AS LNBTSnam, CASE WHEN INSTR(r.LNCELname, '_')=0 THEN NULL ELSE
SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+2,LENGTH(r.LNCELname)) END AS SectorID, 1 AS SectorCnt
FROM LNCEL_Full AS r
WHERE SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+1,1) = "M" COLLATE NOCASE AND r.LNCELname IS NOT NULL;
;
--
DROP TABLE IF EXISTS Sector_L700;
CREATE TABLE Sector_L700 AS
SELECT DISTINCT
r.LNBTSname, SUBSTR(r.LNCELname, 1, INSTR(r.LNCELname, '_')-1) AS LNBTSnam, CASE WHEN INSTR(r.LNCELname, '_')=0 THEN NULL ELSE
SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+2,LENGTH(r.LNCELname)) END AS SectorID, 1 AS SectorCnt
FROM LNCEL_Full AS r
WHERE SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+1,1) = "R" COLLATE NOCASE AND r.LNCELname IS NOT NULL;
;
--
DROP TABLE IF EXISTS Sector_L2600_1;
CREATE TABLE Sector_L2600_1 AS
SELECT DISTINCT
r.LNBTSname, SUBSTR(r.LNCELname, 1, INSTR(r.LNCELname, '_')-1) AS LNBTSnam, CASE WHEN INSTR(r.LNCELname, '_')=0 THEN NULL ELSE
SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+2,LENGTH(r.LNCELname)) END AS SectorID, 1 AS SectorCnt
FROM LNCEL_Full AS r
WHERE SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+1,1) = "L" COLLATE NOCASE AND r.LNCELname IS NOT NULL;
;
--
DROP TABLE IF EXISTS Sector_L2600_2;
CREATE TABLE Sector_L2600_2 AS
SELECT DISTINCT
r.LNBTSname, SUBSTR(r.LNCELname, 1, INSTR(r.LNCELname, '_')-1) AS LNBTSnam, CASE WHEN INSTR(r.LNCELname, '_')=0 THEN NULL ELSE
SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+2,LENGTH(r.LNCELname)) END AS SectorID, 1 AS SectorCnt
FROM LNCEL_Full AS r
WHERE SUBSTR(r.LNCELname, INSTR(r.LNCELname, '_')+1,1) = "T" COLLATE NOCASE AND r.LNCELname IS NOT NULL;
;
--
DROP VIEW IF EXISTS Carrier_Cnt;
CREATE VIEW Carrier_Cnt AS
SELECT LNBTSname, SectorID, SectorCnt FROM Sector_L1900
UNION ALL
SELECT LNBTSname, SectorID, SectorCnt FROM Sector_L700
UNION ALL
SELECT LNBTSname, SectorID, SectorCnt FROM Sector_L2600_1
UNION ALL
SELECT LNBTSname, SectorID, SectorCnt FROM Sector_L2600_2
ORDER BY
    LNBTSname;
--
DROP VIEW IF EXISTS Carrier_CntF;
CREATE VIEW Carrier_CntF AS
SELECT LNBTSname, SectorID, SUM(SectorCnt) AS CarrierNum FROM Carrier_Cnt
WHERE LNBTSname IS NOT NULL
GROUP BY LNBTSname, SectorID
ORDER BY
    LNBTSname, SectorID
;
--
DROP TABLE IF EXISTS Carrier_CntFt;
CREATE TABLE Carrier_CntFt AS
SELECT f.LNBTSname, f.SectorID, f.CarrierNum, l.SectorCnt AS L2600_1, t.SectorCnt AS L2600_2, m.SectorCnt AS L1900,
r.SectorCnt AS L700
FROM (((Carrier_CntF f LEFT JOIN Sector_L2600_1 l ON f.LNBTSname = l.LNBTSname AND f.SectorID = l.SectorID)
LEFT JOIN Sector_L2600_2 t ON f.LNBTSname = t.LNBTSname AND f.SectorID = t.SectorID)
LEFT JOIN Sector_L1900 m ON f.LNBTSname = m.LNBTSname AND f.SectorID = m.SectorID)
LEFT JOIN Sector_L700 r ON f.LNBTSname = r.LNBTSname AND f.SectorID = r.SectorID
WHERE f.LNBTSname IS NOT NULL
ORDER BY
    f.LNBTSname, f.SectorID
;
--
DROP VIEW IF EXISTS Site_Cap1;
CREATE VIEW Site_Cap1 AS
SELECT lp.Zona, lp.Cluster, lp.Region, lp.Depto, lp.Mun, lp.Prefijo, lp.PLMN_id, lp.MRBTS_id, lp.LNBTS_id, lp.LNCEL_id,
lp.LNBTSname, lp.Sector, lp.LNCELname,
f.CarrierNum, l.SectorCnt AS L2600_1, t.SectorCnt AS L2600_2, m.SectorCnt AS L1900, r.SectorCnt AS L700,
sp."WEEK YEAR" AS Week_Year, sp.PRIORITY, sp."SITE PRIORITY" AS Site_Priority, sp.high_load_cell, sp.high_load_cellday_count, sp.high_load_cellhr_count
FROM (((((LTE_Param lp LEFT JOIN Carrier_CntF f ON lp.LNBTSname = f.LNBTSname AND lp.Sector = f.SectorID)
LEFT JOIN Sector_L2600_1 l ON lp.LNBTSname = l.LNBTSname AND lp.Sector = l.SectorID)
LEFT JOIN Sector_L2600_2 t ON lp.LNBTSname = t.LNBTSname AND lp.Sector = t.SectorID)
LEFT JOIN Sector_L1900 m ON lp.LNBTSname = m.LNBTSname AND lp.Sector = m.SectorID)
LEFT JOIN Sector_L700 r ON lp.LNBTSname = r.LNBTSname AND lp.Sector = r.SectorID)
LEFT JOIN SITE_PRIORITY_PER_WEEK sp ON lp.LNCELname = sp.cellname
WHERE lp.LNBTSname IS NOT NULL OR lp.LNCELname IS NOT NULL
ORDER BY lp.LNCELname IS NULL OR lp.LNCELname='', lp.LNCELname;
;
--
DROP VIEW IF EXISTS BSS_LTE;
CREATE VIEW BSS_LTE AS
SELECT bs.Sitio, bs.Region, bs."Equipo RF" AS Equipo_RF, bs."Tipo Trabajo" AS Tipo_Trabajo, bs.Trabajo,
bs."Fecha Solicitado" AS Fecha_Solicitado, bs.Autorizacion
FROM PlanBSS bs
WHERE bs."Tipo Trabajo" LIKE "Ampliacion lte%" COLLATE NOCASE OR bs."Tipo Trabajo" LIKE "Overlay%lte%" COLLATE NOCASE
;
DROP VIEW IF EXISTS BSS_LTE1;
CREATE VIEW BSS_LTE1 AS
SELECT bs.Sitio, bs.Region, bs.Equipo_RF, GROUP_CONCAT(bs.Tipo_Trabajo, ", ") AS TipoTrabajo,
GROUP_CONCAT(bs.Trabajo, ", ") AS Trabajo, GROUP_CONCAT(bs.Fecha_Solicitado, ", ") AS Fecha_Solicitud,
GROUP_CONCAT(bs.Autorizacion, ", ") AS Autorizacion
FROM BSS_LTE bs
GROUP BY bs.Sitio;
--
--
DROP TABLE IF EXISTS Site_Cap;
CREATE TABLE Site_Cap AS
SELECT lp.Zona, lp.Cluster, lp.Region, lp.Depto, lp.Mun, lp.Prefijo, lp.PLMN_id, lp.MRBTS_id, lp.LNBTS_id, lp.LNCEL_id,
lp.LNBTSname, lp.Sector, lp.LNCELname, lp.CarrierNum, lp.L2600_1, lp.L2600_2, lp.L1900, lp.L700,
lp.Week_Year, lp.PRIORITY, lp.Site_Priority, lp.high_load_cell, lp.high_load_cellday_count, lp.high_load_cellhr_count,
bs.Sitio, bs.Region, bs.Equipo_RF, bs.TipoTrabajo, bs.Trabajo, bs.Fecha_Solicitud, bs.Autorizacion
FROM Site_Cap1 lp LEFT JOIN BSS_LTE1 bs ON lp.LNBTSname = bs.Sitio COLLATE NOCASE
ORDER BY lp.LNCELname IS NULL OR lp.LNCELname='', lp.LNCELname;
;
