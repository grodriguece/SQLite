...
SELECT
r.LNCELname, r.CELL_AVAIL AS AvailLast
FROM lweek1 r
...
SELECT
w.Cluster, r.LNCELname, AVG(r.CELL_AVAIL) AS Avg_Cell_Avail, a.Avail_Cnt AS Avail_Days_LT95, l.AvailLast
...
AND l.AvailLast < 0.97)
GROUP BY r.LNCELname
HAVING Avail_Days_LT95 IS NOT NULL AND Avg_Cell_Avail < 0.95
